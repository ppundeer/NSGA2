...
% efficiency
   ...
   power_in_kW = w_net/1000
   thermal_efficiency = n_th
...
% Cummulative cost
   ...
   figure_of_merit = FOM
   levelised_equipment_cost  = LEC
   investment_payback_period  = (C_t17*1.015)/((n_th)*10*(h_hs1-h_hs2)*0.0342)
